	...
	<div class="wrap about__container">
		...
		<?php } ?>
			...
			<nav class="about__header-navigation nav-tab-wrapper wp-clearfix"
				aria-label="<?php esc_attr_e( 'Secondary menu', 'post-type-x' ); ?>">
				<?php
				$getting_started = '';
				$whats_new       = '';
		...
		<div class="return-to-dashboard">
			<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=al_product&page=product-settings.php' ) ); ?>"><?php esc_html_e( 'Go to settings', 'post-type-x' ); ?></a>
		</div>
	</div>
<?php

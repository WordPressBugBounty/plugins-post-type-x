 ...
 * wp-content/themes/your-theme-folder-name/implecode/product-page-inside.php
 *
 * @version 1.1.2
...
?>
	...
	<div id="product_details_container">
		...
		?>
		<div id="product_details" class="product-details <?php echo esc_attr( $details_class ); ?>">
			<?php
...
?>
	<div class="after-product-description">
		<?php do_action( 'single_product_end', $product, $single_names, $current_taxonomy ); ?>
	</div>
